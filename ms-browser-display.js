...
MSBrowser.prototype.build_widget = function () {
    ...
    // events
    $("#ms_browser_channels_tab", this.$menu).click({ obj: this }, function (evt) { evt.data.obj.change_tab("channels"); return false; });
    $("#ms_browser_search_tab", this.$menu).click({ obj: this }, function (evt) { evt.data.obj.change_tab("search"); return false; });
    $("#ms_browser_latest_tab", this.$menu).click({ obj: this }, function (evt) { evt.data.obj.change_tab("latest"); return false; });
